  ...
  const handleSignUp = (data) => {
    ...
    .then(
        (res) => {
            ...
            alert('Sign up successfully. Please proceed to login.')
            handleLogin();  // sign up sucessfully, navigate to login page
        })
    .catch((error) => {
        const res =
        ...
        <div className='z-0 relative'>
            <div className='w-[400px] m-auto p-6 mt-3 mb-5 bg-white bg-opacity-70 rounded-lg text-black justify-center items-center'>
              ...
              className='flex flex-col gap-2 p-2'>
                ...
                <button type='submit' className='mt-3 bg-blue-500 text-white px-5 py-2 rounded-full hover:bg-blue-700'>
                    Sign Up
                </button>
              ...
              <p className='text-sm p-2'>
                Already a user?
                <span>
                  <button onClick={handleLogin} className='text-sm underline gap-2 p-2 hover:underline hover:text-blue-800'>
                    Login
                  </button>
                </span>
              </p>
